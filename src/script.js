...
var releasesJson = [
    {
      "Title": "Nocturno",
      "Image": "images/releases/Nocturno.jpg",
    ...
    },
    {
      ...
      "Image": "images/releases/OnlyYou.jpg",
    ...
    },
    {
      ...
      "Image": "images/releases/summerinbali.jpg",
    ...
    {
      "Title": "Jay Fragibans",
      "Image": "images/releases/jayfragi.png",
    ...
    },
    {
      ...
      "Image": "images/releases/Wonderlandrmx.jpg",
    ...
    {
      "Title": "Moonlight",
      "Image": "images/releases/moonlight.jpg",
      "Subtitle": "John Spider",
    ...
    {
      "Title": "Invaders",
      "Image": "images/releases/invaders.jpg",
      "Subtitle": "John Spider",
    ...
    {
      "Title": "Let It Ride",
      "Image": "images/releases/letitride.jpg",
      "Subtitle": "John Spider",
    ...
    {
      "Title": "Evolution",
      "Image": "images/releases/evolution.jpg",
    ...
    {
      "Title": "Raindrops",
      "Image": "images/releases/Raindrops.jpg",
      "Subtitle": "John Spider",
    ...
    },
    {
      ...
      "Image": "images/releases/AllOfYourLove.jpg",
      "Subtitle": "John Spider & Ricardo Elgardo",
    ...
    },
    {
      ...
      "Image": "images/releases/sunrise.jpg",
    ...
    {
      "Title": "Daybreak (EP)",
      "Image": "images/releases/daybreak.jpg",
      "Subtitle": "John Spider & Ricardo Elgardo",
      "ItemPageText": "SOL284",
    ...
    {
      "Title": "Vibe",
      "Image": "images/releases/vibe.jpg",
      "Subtitle": "John Spider",
    ...
    {
      "Title": "Sunset Dream",
      "Image": "images/releases/sunsetDream.jpg",
      "Subtitle": "John Spider",
    ...
    },
    {
      ...
      "Image": "images/releases/thatsummerday.jpg",
      "Subtitle": "John Spider",
    ...
    {
      "Title": "Cast Away",
      "Image": "images/releases/castaway.jpg",
      "Subtitle": "John Spider",
    ...
    {
      "Title": "Desert Winds",
      "Image": "images/releases/desertwindds.jpg",
    ...
    {
      "Title": "Worlds",
      "Image": "images/releases/worlds.jpg",
      "Subtitle": "John Spider",
    ...
    {
      "Title": "Breeze",
      "Image": "images/releases/Breeze.jpg",
      "Subtitle": "John Spider",
    ...
    {
      "Title": "Lost Cafe",
      "Image": "images/releases/lostcafe.jpg",
      "Subtitle": "John Spider",
    ...
    },
    {
      ...
      "Image": "images/releases/icebreaker.jpg",
